/*
* ESTE ES UN ARCHIVO DE PRUEVA DEL MAIN USADO CON EL LAYOUT Y CLASSES ACTUALES, EN ESTE SE ENSEÑA COMO USAR LA CLASSE DE 
* RENDER COMO TAL PARA LA CLASSE GAME, PARA QUE LOS INCLUDES FUNCIONEN, SE DEBERIA USAR ESTE ARCHIVO FUERA DE LA CARPETA
* DE GRAFICOS. ESTE TAMBIEN SIRVE COMO BACKUP PARA EL MERGE DEL MAIN DE GRAFICOS
*/
